...
def is_plausible_sitename(
    metadata: Metadata, candidate: Any, content_type: Optional[str] = None
) -> bool:
...
def process_parent(parent: Any, metadata: Metadata) -> Metadata:
...
def extract_json(
    schema: Union[List[Any], Dict[str, str]], metadata: Metadata
) -> Metadata:
...
def extract_json_parse_error(elem: str, metadata: Metadata) -> Metadata:
